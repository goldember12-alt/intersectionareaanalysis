...
Context inputs available for bounded enrichment:
...
Sorted files:
- active: `active/__main__.py`, `active/config.py`, `active/study_slice.py`, `active/directionality_experiment.py`, `active/upstream_downstream_prototype.py`, `active/high_confidence_upstream_downstream_analysis.py`, `active/context_enrichment.py`, `active/context_enrichment_access_same_corridor_prototype.py`
...
Use `docs/workflow/active_workflow.md` for the current active story.
